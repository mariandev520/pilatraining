...
// Componente principal de jumping con diseño mejorado
const jumping = () => {
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            try {
                ...
                const clientesConPilates = dataClientes.filter(c => c.actividades?.some(act => act.nombre.toLowerCase().includes('jumping')));
...
const guardarAsignaciones = async () => {
    ...
    try {
        ...
        const response = await fetch('/api/jumping', {
            method: 'POST',
                            ...
                            >
                                <Box>
                                    ...
                                    <Typography variant="caption" display="block" sx={{ mt: 0.5 }}>
                                        Haz clic en una jump para asignar
                                    </Typography>
                                </Box>
                            </Alert> 
                        )}
                                ...
                                >
                                    ...
                                    <Box sx={{flexGrow: 1}}>
                                        ...
                                        <Typography variant="caption" color="textSecondary">
                                            Selecciona una Jump para asignar
                                        </Typography>
                                    </Box>
                                    <Button 
                                        sx={{ 
